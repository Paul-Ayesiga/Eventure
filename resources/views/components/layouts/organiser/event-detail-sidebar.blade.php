...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="dark">
    ...
    <body class="min-h-screen bg-gradient-to-br from-white via-gray-100 to-white dark:from-gray-800 dark:via-gray-900 dark:to-gray-800 bg-fixed">
        <flux:header container class="border-b border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
            ...
            <flux:brand href="{{ route('events') }}" name="Eventure" wire:navigate>
        ...
        <flux:sidebar stashable sticky class="lg:hidden border-r border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
            ...
            <flux:navlist variant="outline">
                <flux:navlist.group :heading="__('Event Management')">
                    <flux:navlist.item icon="layout-dashboard" href="{{ route('event-details', ['id' => $eventId]) }}" :current="request()->routeIs('event-details')" wire:navigate>
                        {{ __('Overview') }}
                    </flux:navlist.item>
                    <flux:navlist.item icon="ticket" href="{{ route('event-tickets', ['id' => $eventId]) }}" :current="request()->routeIs('event-tickets')" wire:navigate>
                        {{ __('Tickets') }}
                    </flux:navlist.item>
                    ...
                    <flux:navlist.item icon="cog-6-tooth" href="{{ route('event-settings', ['id' => $eventId]) }}" :current="request()->routeIs('event-settings')" wire:navigate>
                        {{ __('Settings') }}
                    </flux:navlist.item>
                </flux:navlist.group>
            </flux:navlist>
            ...
            <flux:navlist variant="outline">
                <flux:navlist.item icon="arrow-left" href="{{ route('events') }}" wire:navigate.hover>{{ __('Back to Events') }}</flux:navlist.item>
