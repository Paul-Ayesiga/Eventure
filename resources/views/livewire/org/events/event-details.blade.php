    ...
    <div class="p-4 sm:p-6 lg:p-8">
        ...
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
            ...
            <div class="flex gap-2">
                @if(!$isEditing)
                    <flux:button wire:click="toggleEdit" variant="primary" class="cursor-pointer">Edit Event</flux:button>
                @endif
            </div>
        </div>
            ...
            <form wire:submit.prevent="update" class="space-y-6">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
                            ...
                            <div class="relative mt-2">
                                ...
                                >
                                    <template x-for="suggestion in suggestions" :key="suggestion.place_id">
                                        ...
                                        >
                                            <div class="text-sm font-medium text-gray-900 dark:text-gray-200" x-text="suggestion.display_place"></div>
                                            <div class="text-xs text-gray-500 dark:text-gray-400 mt-0.5" x-text="suggestion.display_address"></div>
                                        </div>
                                    </template>
                                </div>
                            </div>
                    ...
                    @if($event->location)
                        <div class="mt-4">
                            <div id="map" class="h-64 w-full rounded-lg relative">
                                ...
                                <div id="map-placeholder" class="absolute inset-0 bg-gray-100 dark:bg-gray-800 rounded-lg overflow-hidden">
                                    ...
                                    <div class="h-full w-full skeleton-loader shimmer">
                                        <div class="absolute inset-0 flex flex-col items-center justify-center">
                                            ...
                                            <div class="space-y-2 text-center">
                                                <p class="text-gray-600 dark:text-gray-300 text-sm font-medium">Loading map...</p>
                                                <p class="text-gray-400 dark:text-gray-500 text-xs">{{ $event->venue }}</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="mb-6">
                        ...
                        <select wire:model="category" class="w-full border rounded p-2 mt-2 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
                    ...
                    <div class="mb-6">
                        ...
                        <select wire:model="event_repeat" class="w-full border rounded p-2 mt-2 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
                        ...
                        <div>
                            ...
                            <select wire:model="timezone" class="w-full border rounded p-2 mt-1 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                    ...
                    <div class="mb-6">
                        <label class="flex items-center">
                            <input type="checkbox" wire:model="convert_timezone" class="form-checkbox h-5 w-5 text-teal-500">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
                    ...
                    <div class="mb-6">
                        ...
                        <select wire:model="currency" class="w-full border rounded p-2 mt-2 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                    ...
                    <div class="mb-6">
                        ...
                        <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">
                            We may display your event on our explore events page if it meets our publishing guidelines. It helps increase your event's discoverability, resulting in more bookings for your event.
                        </p>
                    </div>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
                    ...
                    <div class="space-y-6">
                        <div>
                            <h3 class="text-sm uppercase tracking-wider font-medium text-gray-500 dark:text-gray-400">Active Tickets</h3>
                        ...
                        <div>
                            <h3 class="text-sm uppercase tracking-wider font-medium text-gray-500 dark:text-gray-400">Total Sold</h3>
                            <p class="mt-2 text-base font-medium dark:text-white">
                        ...
                        <div>
                            <h3 class="text-sm uppercase tracking-wider font-medium text-gray-500 dark:text-gray-400">Revenue</h3>
                            <p class="mt-2 text-base font-medium dark:text-white">
                                {{ number_format($event->tickets->sum(function($ticket) { return $ticket->quantity_sold * $ticket->price; }), 2) }} {{ $event->currency }}
                            </p>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="mt-2">
                            ...
                            <div class="flex flex-wrap gap-2 mb-2">
                                @foreach($tags as $index => $tag)
                                    <span class="inline-flex items-center bg-gray-100 dark:bg-gray-700 rounded-full px-3 py-1">
                                        <span class="text-sm">{{ $tag }}</span>
                                        <button type="button" wire:click="removeTag({{ $index }})" class="ml-1 text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200">
                                ...
                                @foreach($banners as $index => $banner)
                                    <div class="relative group">
                                        ...
                                        <div class="relative w-full h-40 rounded-lg overflow-hidden">
                                            <!-- Skeleton loader -->
                                            <div class="absolute inset-0 skeleton-loader shimmer flex items-center justify-center">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
                    ...
                    <div class="space-y-6">
                        <div>
                            <h3 class="text-sm uppercase tracking-wider font-medium text-gray-500 dark:text-gray-400">Status</h3>
                            <p class="mt-2">
                                <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium {{ $event->status === 'Published' ? 'bg-green-100 text-green-800' : 'bg-yellow-100 text-yellow-800' }}">
                                    {{ $event->status }}
                                </span>
                            </p>
                            <flux:separator class="mt-4"/>
                        ...
                        <div>
                            <h3 class="text-sm uppercase tracking-wider font-medium text-gray-500 dark:text-gray-400">Currency</h3>
                            <p class="mt-2 text-base font-medium dark:text-white">{{ $event->currency }}</p>
                            <flux:separator class="mt-4"/>
                        </div>
                        <div>
                            <h3 class="text-sm uppercase tracking-wider font-medium text-gray-500 dark:text-gray-400">Timezone Conversion</h3>
                            <p class="mt-2 text-base font-medium dark:text-white">
        ...
        @else
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
                    ...
                    <div class="space-y-6">
                        <div>
                            <h3 class="text-sm uppercase tracking-wider font-medium text-gray-500 dark:text-gray-400">Event Type</h3>
                            <p class="mt-2 text-base font-medium dark:text-white">{{ ucfirst($event->event_type) }}</p>
                            <flux:separator class="mt-4"/>
                        </div>
                        <div>
                            <h3 class="text-sm uppercase tracking-wider font-medium text-gray-500 dark:text-gray-400">Venue</h3>
                            <p class="mt-2 text-base font-medium dark:text-white">{{ $event->venue ?: 'Not specified' }}</p>

                            @if($event->location)
                                <div class="mt-4">
                                    <div id="map" class="h-64 w-full rounded-lg relative">
                                        <!-- Map Placeholder -->
                                        <div id="map-placeholder" class="absolute inset-0 bg-gray-100 dark:bg-gray-700 rounded-lg flex flex-col items-center justify-center">
                                            ...
                                            <p class="text-gray-400 dark:text-gray-500 text-xs mt-1">{{ $event->venue }}</p>
                                        </div>
                                    </div>
                                </div>
                            @endif
                        ...
                        <div>
                            <h3 class="text-sm uppercase tracking-wider font-medium text-gray-500 dark:text-gray-400">Category</h3>
                            <p class="mt-2 text-base font-medium dark:text-white">{{ $event->category ?: 'Not specified' }}</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
                    ...
                    <div class="space-y-6">
                        <div>
                            <h3 class="text-sm uppercase tracking-wider font-medium text-gray-500 dark:text-gray-400">Event Date</h3>
                            <p class="mt-2 text-base font-medium dark:text-white">
                        ...
                        <div>
                            <h3 class="text-sm uppercase tracking-wider font-medium text-gray-500 dark:text-gray-400">Time</h3>
                            <p class="mt-2 text-base font-medium dark:text-white">
                        ...
                        <div>
                            <h3 class="text-sm uppercase tracking-wider font-medium text-gray-500 dark:text-gray-400">Timezone</h3>
                            <p class="mt-2 text-base font-medium dark:text-white">{{ $event->timezone }}</p>
                            <flux:separator class="mt-4"/>
                        </div>
                        <div>
                            <h3 class="text-sm uppercase tracking-wider font-medium text-gray-500 dark:text-gray-400">Repeat</h3>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6 md:col-span-3">
                    ...
                    <div class="space-y-6">
                        <div>
                            <h3 class="text-sm uppercase tracking-wider font-medium text-gray-500 dark:text-gray-400">Description</h3>
                            <p class="mt-2 text-base dark:text-white">{{ $event->description ?: 'No description provided' }}</p>
                            <flux:separator class="mt-4"/>
                        </div>
                        <div>
                            <h3 class="text-sm uppercase tracking-wider font-medium text-gray-500 dark:text-gray-400">Tags</h3>
                        ...
                        <div>
                            <h3 class="text-sm uppercase tracking-wider font-medium text-gray-500 dark:text-gray-400">Banners</h3>
                            <div class="mt-2 space-y-2">
                                ...
                                @empty
                                    <div class="flex items-center justify-center h-40 bg-gray-50 dark:bg-gray-800 rounded-lg">
                                        <div class="text-center">
                                            <svg class="mx-auto h-12 w-12 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
                                            </svg>
                                            <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">No banners added</p>
                                        </div>
                                    </div>
                                @endforelse
                            </div>
...
function venueSearch() {
    return {
        ...
        async fetchSuggestions() {
            ...
            this.isLoading = true;
            try {
                const response = await fetch(`https://api.locationiq.com/v1/autocomplete?key=${this.locationiqKey}&q=${encodeURIComponent(this.query)}&format=json&limit=5`);
